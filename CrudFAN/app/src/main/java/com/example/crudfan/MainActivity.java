...
public class MainActivity extends AppCompatActivity {
    ...
    public void aksiButton(){
        ...
        btnLihat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Next Tutorial ya !" , Toast.LENGTH_SHORT).show();
            }
        });
    }
    public void tambahData(String nim, String nama, String kelas){
        ...
        AndroidNetworking.post("http://192.168.1.205/crud_fan/create.php")
